...
If you are following the "Build with AI" codelab from the `main` branch, the table below maps exactly which functionality needs to be implemented, the file it belongs in, and the corresponding marker.
