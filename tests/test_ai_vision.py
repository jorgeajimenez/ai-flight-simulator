...
def test_analyze_and_terraform_success(mocker):
    ...
    mock_imagen_class = mocker.patch("services.ai_vision.ImageGenerationModel.from_pretrained")
    ...
    # 3. Execute Service
    result = AIVisionService.analyze_and_terraform(b"original-satellite-bytes", "Cyberpunk City")
